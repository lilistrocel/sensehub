...
This command **requires** the project directory as an argument via `/home/noobcity/Code/SenseHub`.

**Example:** `/create-spec generations/my-app`

**Output location:** `/home/noobcity/Code/SenseHub/.autoforge/prompts/app_spec.txt` and `/home/noobcity/Code/SenseHub/.autoforge/prompts/initializer_prompt.md`

If `/home/noobcity/Code/SenseHub` is empty, inform the user they must provide a project path and exit.
...
The output directory is: `/home/noobcity/Code/SenseHub/.autoforge/prompts/`

Once the user approves, generate these files:

## 1. Generate `app_spec.txt`

**Output path:** `/home/noobcity/Code/SenseHub/.autoforge/prompts/app_spec.txt`
...
**Output path:** `/home/noobcity/Code/SenseHub/.autoforge/prompts/initializer_prompt.md`
...
**Output path:** `/home/noobcity/Code/SenseHub/.autoforge/prompts/.spec_status.json`
...
> "Your specification files have been created in `/home/noobcity/Code/SenseHub/.autoforge/prompts/`!
>
> **Files created:**
> - `/home/noobcity/Code/SenseHub/.autoforge/prompts/app_spec.txt`
> - `/home/noobcity/Code/SenseHub/.autoforge/prompts/initializer_prompt.md`
>
